...
-- GLOBALS: ElvUF_Raid30

function UF:Construct_Raid30Frames()
...
function UF:Update_Raid30Header(header, db)
	...
	if not parent.positioned then
		...
		E:CreateMover(parent, parent:GetName()..'Mover', L["Raid-30 Frames"], nil, nil, nil, 'ALL,RAID', nil, 'unitframe,groupUnits,raid30,generalGroup')
		parent.positioned = true
	end
end

function UF:Update_Raid30Frames(frame, db)
	frame.db = db
